...
- `swift test` — two targets, `SnapCoreTests` (630 tests) and `SystemAdaptersTests` (122). Plain
...
`swift build` is clean and `swift test` is green (122 + 630 tests) at this commit. The app target has
