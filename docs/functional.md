...
**The window has six pages, picked from a toolbar** that draws each page's symbol above its title —
*General*, *Snapping*, *Snap Bar*, *Handles*, *Custom Areas*, *System* — and the window's title is the
